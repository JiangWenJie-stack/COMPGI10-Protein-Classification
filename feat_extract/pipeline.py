...
class res(object):
    def __init__(self, trainingDir, testingDir, resultsDir, GetTrainingFeatures, GetTestFeatures, classType, classifierType, outputTrainedModel):
        self.trainingDir=trainingDir 
        self.testingDir=testingDir
        self.resultsDir=resultsDir 
        self.GetTrainingFeatures=GetTrainingFeatures 
        self.GetTestFeatures=GetTestFeatures 
        self.classType=classType 
        self.classifierType=classifierType 
        self.outputTrainedModel=outputTrainedModel        
...
def pipeline(results):
    ...
    if GetTestFeatures==True:
        ...
        #dfTesting = pd.DataFrame.from_csv('testingSetFeatures.csv')
